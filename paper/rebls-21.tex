...
the inputs in a single global timeline such that all instances observe them
identically.
...
\end{itemize}
%
In our synchronization algorithm, we do not assume any strict bounds in clock
differences and network delays, which may of course affect the viability of
some applications.
%
The algorithm has the following goals:
%
\begin{enumerate}
...
global source of non determinism.
