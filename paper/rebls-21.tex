...
\newcommand{\dapp}{\emph{dapp}}
\newcommand{\dapps}{\emph{dapps}}
...
As introduced in Section~\ref{sec.arch}, resynchronization adds a delta delay to
...
\item \textbf{Clock differences:}
    ...
    The offset refers to the point in time since the \dapp
\end{itemize}
